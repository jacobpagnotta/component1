...
data.MaleNames = {'Fred','Jim','Gary','John', 'Cameron', 'Robert', 'Andy', 'Thomas', 'Richard', 'Elias'}
data.FemaleNames = {'Mary','Sabrina','Tracy', 'Connie', 'Sarah', 'Allie', 'Amanada', 'Karen' }
...
data.PCPfacility = { 'ABC Hospital', 'XYZ Hospital', 'LMN General' }
data.PatientClass = {'I', 'O', 'B', 'E', 'P', 'R'}
data.Doctor = {'DoctorA', 'DoctorB', 'DoctorC'}
...
local function ranDoctor() return ranChoose(data.Doctor) end
...
local function ranPCPfacility()
   return ranChoose(data.PCPfacility)
end
 
local function ranPatientClass()
   return ranChoose(data.PatientClass)
end
...
local function ranPhone()
   local R = math.random(999)..'-'
   ..math.random(999)..'-'
   ..math.random(9999)
   return R
end 
...
local function ranPD1(PD1)
   PD1[4][1][1] = math.random(9)
   PD1[4][1][2][1] = ranLastName()
   PD1[4][1][3] = ranFirstName()
   PD1[3][1][1] = ranPCPfacility()
end


local function ranPV1(PV1)
   PV1[8][1][2][1] = ranDoctor()
   PV1[8][1][3] = ranFirstName()
   PV1[8][1][4] = 'F'
   PV1[2] = ranPatientClass()
